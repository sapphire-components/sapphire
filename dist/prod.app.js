/*! prod.app.js || Version: 5.5.339 || Generated: Fri May 29 2026 15:56:00 GMT+0100 (Hora de verão da Europa Ocidental) */
...
/***/ "./src/components/05-components/globals.js":
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {

const packageVersion = (__webpack_require__("./package.json").version);
...
(function ($, window, document, SapphireWidgets) {
	...
	function guardHandler(e, opts) {
		...
		const excludedClasses = ['buttongroup', 'IconDropdown_button'];
		const hasExcludedClass = [...target.classList].some((cls) => excludedClasses.some((excluded) => cls.toLowerCase().includes(excluded.toLowerCase())));
	...
	function create(userOpts = {}) {
		...
		document.querySelectorAll(opts.classes.map((c) => `.${CSS.escape(c)}`).join(',')).forEach((el) => el.classList.add(opts.awareClass));
...
/***/ "./src/components/05-components/v3-pat-2026/hourpicker2/script.js":
/***/ (function() {
...
/***/ "./src/components/05-components/v3-pat-2026/tippytooltip/scripts.js":
/***/ (function() {
...
$.fn.menuInline = function (notifyId, type, isFullWidth = false, actionsClass, _backgroundColor, dataId, theme_in) {
	const theme = theme_in;
	...
	if (linkWidget.getAttribute('onclick') != null) {
		linkWidget.setAttribute(
			...
			linkWidget
				...
				.toString()
				.replace('if( ret != true )', "$('" + linkId + "').get(0).setAttribute('confirmed', ret); if( ret != true )"),
		);
	}
        ...
        $.data(event.target,"os-internal-processing", true);
			...
			(function (popupDiv) {
				_iframe.load(function () {
					const iframeEl = _iframe[0];
					iframeEl.dataset.theme = theme;
