...
SapphireWidgets.SelectSystem = config => {
	$(function () {
			...
			*/
			...
			if (config.SelectType === 'HtmlOptions') { // HtmlOptions
					var dataHtmlOption = [];
			...
			// It doesn't look like these handlers can work like this. Probably no consumer is passing them.
